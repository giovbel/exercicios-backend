...
var media = require('./modulo/mediaEscolar')
                                ...
                                entradaDados.question('Nota 3: ', function (terceiraNota) {
                                    ...
                                    entradaDados.question('Nota 4: ', function (quartaNota) {
                                        ...
                                        if (mediaFinal != undefined) {
                                            let status = media.mostrarStatus(media)
                                            console.log('')
                                            console.log('----------------------------')
                                            mediaRelatorio.relatorioAluno(aluno,professor, sexoAluno,sexoProfessor, curso, disciplina, media)
                                            if (status == 'exame') {
                                                console.log()
                                                entradaDados.question('Nota do exame: ', function (notaExame) {

                                                    let nota5 = notaExame
                                                    let mediaNota5 = mediaRelatorio.exameCalculo(mediaRelatorio, nota5)
